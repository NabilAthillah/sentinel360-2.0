    ...
    return (
        <div className="min-h-screen bg-[#181D26] text-white flex flex-col gap-4">
            ...
            <div className="space-y-3 mb-6 p-4">
                <h2 className="text-sm text-[#98A1B3]">Optional</h2>
                <button className="flex items-center justify-between bg-[#222630] px-4 py-5 rounded-md w-full hover:bg-[#2c313d] transition">
                    <span className="text-[#F9F9F9] font-normal">Add voicenote</span>
                    <ChevronRight size={18} className="text-[#98A1B3]" />
                </button>
                <button className="flex items-center justify-between bg-[#222630] px-4 py-5 rounded-md w-full hover:bg-[#2c313d] transition">
                    <span className="text-[#F9F9F9] font-normal">Take picture</span>
                    <ChevronRight size={18} className="text-[#98A1B3]" />
                </button>
            </div>

            <div className="mb-6 p-4">
                <h2 className="text-sm text-[#98A1B3] mb-3">Check and clear list</h2>
                <label className="flex items-center gap-3 mb-2 cursor-pointer">
                    <input
                        type="checkbox"
                        checked={checks.rubbish}
                        onChange={() => toggleCheck("rubbish")}
                        className="w-5 h-5 rounded border border-gray-400 appearance-none checked:bg-[#2DCBAB] checked:border-[#2DCBAB] relative 
               after:content-['✔'] after:text-[#F5F5F5] after:text-sm after:absolute after:top-1/2 after:left-1/2 
               after:-translate-x-1/2 after:-translate-y-1/2 after:hidden checked:after:block"
                    />
                    <span>Clear of rubbish</span>
                </label>
               ...
               after:-translate-x-1/2 after:-translate-y-1/2 after:hidden checked:after:block"
                    />
                    <span>Fire hazard notification</span>
                </label>

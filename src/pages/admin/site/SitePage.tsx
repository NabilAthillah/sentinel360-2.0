        ...
        <SecondLayout>
            ...
            <div className="flex flex-col gap-6 pl-4 pr-[156px] pb-20 w-full h-full flex-1">
                ...
                <nav className="flex flex-wrap border-b border-[#2E3544]">
                    <Link
                        to="/dashboard/sites"
                        className={`font-medium text-sm text-[#F4F7FF] px-6 ${pathname === "/dashboard/sites"
                    ...
                    <Link
                        ...
                        className={`font-medium text-sm text-[#F4F7FF] px-6 ${pathname === "/dashboard/sites/map"
                            ? "pt-[14px] pb-3 border-b-2 border-b-[#F3C511]"
                            : "py-[14px]"
                            }`}
                    >
                    ...
                    <Link
                        ...
                        className={`font-medium text-sm text-[#F4F7FF] px-6 ${pathname === "/dashboard/sites/allocation"
                            ? "pt-[14px] pb-3 border-b-2 border-b-[#F3C511]"
                            : "py-[14px]"
                            }`}
                    >
                            ...
                            <table className="min-w-[800px] w-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="font-semibold text-[#98A1B3] text-start">{t("Address")}</th>
                                        <th className="font-semibold text-[#98A1B3] text-start">{t("Latitude")}</th>
                                ...
                                <tbody >
                                    <tr>
                                        ...
                                        <td className="text-[#EFBF04] py-3">The Rainforest</td>
                                        <td className="text-[#F4F7FF] pt-6 pb-3">Appolo St 34 Singapore 540233</td>
                                        <td className="text-[#F4F7FF] pt-6 pb-3">1.21431245</td>
                                        <td className="text-[#F4F7FF] pt-6 pb-3">1.29976245</td>
                                        <td className="pt-6 pb-3">
                                            <div className="flex gap-6 items-center justify-center">
                                                <svg 
                                                onClick={() => navigate("/dashboard/sites/routes")}
                                                className="cursor-pointer" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M2 4H0V18C0 19.105 0.895 20 2 20H16V18H2V4ZM18 0H6C4.895 0 4 0.895 4 2V14C4 15.105 4.895 16 6 16H18C19.105 16 20 15.105 20 14V2C20 0.895 19.105 0 18 0ZM17 9H13V13H11V9H7V7H11V3H13V7H17V9Z" fill="#F9F9F9" />
                                                </svg>
                                                <svg
                                                    className="cursor-pointer" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <SlideOver isOpen={addData} onClose={() => setAddData(false)} ariaTitle="Add site" width={568}>
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 p-6 max-h-full">
                    ...
                    <div className="flex flex-col w-full px-4 pt-2 pb-1 bg-[#222834] border-b border-b-[#98A1B3]">
                        <label className="text-xs text-[#98A1B3]">MA Name</label>
                        <input
                            type="text"
                            className="w-full bg-[#222834] text-[#F4F7FF] text-base focus:outline-none"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {["Block", "Unit"].map((field, i) => (
                            <div
                                key={i}
                                className="flex flex-col px-4 pt-2 pb-1 bg-[#222834] border-b border-b-[#98A1B3]"
                            >
                                <label className="text-xs text-[#98A1B3]">{field}</label>
                                <input
                                    type="text"
                                    className="w-full bg-[#222834] text-[#F4F7FF] text-base focus:outline-none"
                                    placeholder={field}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    const file = e.target.files?.[0];
                                    if (file) setChartName(file.name);
                                }}
                                className="hidden"
                            />
                        </div>
